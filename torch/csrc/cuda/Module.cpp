...
PyObject * THCPModule_renew_shared_memory(PyObject *self, PyObject *noargs)
{
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::renew_shared_memory();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}

PyObject * THCPModule_mark_shared_memory(PyObject *self, PyObject *noargs)
{
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::mark_shared_memory();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}

PyObject * THCPModule_unmark_shared_memory(PyObject *self, PyObject *noargs)
{
  HANDLE_TH_ERRORS
  c10::cuda::CUDACachingAllocator::unmark_shared_memory();
  END_HANDLE_TH_ERRORS
  Py_RETURN_NONE;
}
...
static struct PyMethodDef _THCPModule_methods[] = {
  ...
  {"_cuda_renew_shared_memory", THCPModule_renew_shared_memory, METH_NOARGS, nullptr},
  {"_cuda_mark_shared_memory", THCPModule_mark_shared_memory, METH_NOARGS, nullptr},
  {"_cuda_unmark_shared_memory", THCPModule_unmark_shared_memory, METH_NOARGS, nullptr},
#ifdef USE_NCCL
