...
def renew_shared_memory() -> None:
    if is_initialized():
        torch._C._cuda_renew_shared_memory()

def mark_shared_memory() -> None:
    if is_initialized():
        torch._C._cuda_mark_shared_memory()

def unmark_shared_memory() -> None:
    if is_initialized():
        torch._C._cuda_unmark_shared_memory()
